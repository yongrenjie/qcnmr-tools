...
#    for each isomer.
#  - incomplete assignments for proton data can be indicated with asterisk(s) at the end of the atom label in
#    dp4_expt.txt. Each set of assignments which can be swapped should have atom labels that end with the same number of
#    asterisks. For example, if the pairs H5a/H5b and H8a/H8b are not confidently assigned, then you can enter the atom
#    labels as H5a*, H5b*, H8a**, and H8b**.
