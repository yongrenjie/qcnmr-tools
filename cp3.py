...
#
# In both calc.txt and expt.txt, the atom labels MUST align exactly! Both files can be generated by copy-pasting
# relevant cells from Excel into calc.txt directly. See calc.txt and expt.txt in this folder for a real-life example.
#
